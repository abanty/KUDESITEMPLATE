...
<div class="wrap-embed-contact-form">
	...
	<form class="embed-contact-form">
		<div class="form-heading">Contáctanos</div>
		<!-- <div class="form-sub-heading">Por favor, rellene el formulario para ponerse en contacto!</div> -->
		<!-- <hr> -->
		...
		<div class="form-content">
			<div class="group">
				...
				<div><input id="name" name="name" placeholder="Tu Nombre" class="form-control"></div>
			</div>
			<div class="group">
				<label for="email" class="empty"></label>
				<div><input type="email" name="email" placeholder="Tu Email" class="form-control"></div>
			</div>
			<div class="group">
				<label for="query-type">Asuntos</label>
				<div>
					<select id="query-type" name="query-type" class="form-control">
						<option value="General Query">Consulta General</option>
						<option value="Presale">Sugerencias</option>
			...
			<div class="group">
				...
				<div><textarea id="message" name="message" placeholder="Tu Mensaje" class="form-control" rows="5"></textarea></div>
			</div>
			<div class="group">
				<label class="empty"></label>
				<div><button class="btn-submit" type="submit">Enviar Mensaje</button></div>
			</div>
		</div>
		<a id="msgform" class="btn-show-contact" href="#contact" data-toggle="tooltip" data-placement="top" title="Has Click Aqui!" ><img src="<?php echo $path; ?>img/btn_contact.png"></a>
	</form>
</div>
